...
{DZE_CLICK_ACTIONS set [count DZE_CLICK_ACTIONS,[_x,"Commit Suicide",format["'%1' execVM 'addons\suicide\suicide.sqf';",_x]]];} forEach DZE_SUICIDE_WEAPONS;